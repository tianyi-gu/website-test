...
export default function Home() {
  return (
    <div>
      ...
      <Head>
        {/* <meta property="twitter:url" content="https://iamtianyi.com/" /> */}
        <script defer data-domain="iamtianyi.com" src="https://plausible.io/js/plausible.js"></script>
      </Head>
      <Nav active="Home" />
      <main className="mt-6 sm:mt-12 md:mt-16 flex flex-col text-white pl-12 md:pl-20">
        <section className="heading" aria-hidden="true">
          <div>Tianyi Evans Gu<div className="inline opacity-50">.</div></div>
        </section>
        <section className="mt-8 md:mt-16 w-2/3 lg:w-1/2 md:text-xl">
          Hey! I'm Tianyi; this is a <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="https://www.google.com">thing</a>
          <br /><br />
        ...
        <section className="mt-8 md:mt-8 w-2/3 lg:w-1/2 md:text-xl">
          <div className="icon-bar">
            <a href="https://www.linkedin.com/in/tianyi-evans-gu/"><svg fill="white" height="20px" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>LinkedIn</title>
              <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
            </a>
            <a href="https://www.instagram.com/iamtianyi/"><svg fill="white" height="20px" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Instagram</title>
            ...
            <a href="https://github.com/tianyi-gu"><svg fill="white" height="20px" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/">
              <title>Github</title>
            ...
            <a href=""><svg role="img" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Substack</title><path d="M22.539 8.242H1.46V5.406h21.08v2.836zM1.46 10.812V24L12 18.11 22.54 24V10.812H1.46zM22.54 0H1.46v2.836h21.08V0z" fill="white"></path></svg></a> */}

          </div>
        </section>
        <section>
          <img className="mt-8 md:mt-12 w-1/2 sm:w-1/3 lg:w-1/4" src="/signature.png" alt="signature here" aria-hidden="true" />
        </section>
      </main>
      <footer className="text-white mt-8 md:mt-16 pl-12 md:pl-20 mb-5 flex flex-col space-y-4 text-xs sm:text-sm">
        ...
        <div className="font-gilroy uppercase opacity-40">
          Copyright {new Date().getFullYear()} Tianyi Evans Gu.
        </div>
      </footer>
    </div>
  )
